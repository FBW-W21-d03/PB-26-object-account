...
console.log("................");
console.log("Neu Bank:", kontoChuck.bank);
console.log("IBAN:", kontoChuck.iban);
console.log("Bankleizahl:", kontoChuck.Bankleizahl);
console.log("Kontostand:", kontoChuck.Kontostand);
console.log("Dispo:", kontoChuck.Dispo);